    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 tur-ecs2-right-otstup">
                ...
                <div class="container-fluid" style="padding-right:0; padding-left:0;border-radius: 8px;
                        background: linear-gradient(90deg, rgba(10, 0, 178, 0.5) 0%, rgba(255, 0, 0, 0.5) 50%, rgba(255, 252, 0, 0.5) 100%);">
                    <div class="tur-content-calendar-border">
                        <div class="tur-content-calendar-exc-block-in">



                            <?php if (get_field('ponedelnik') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center" style="padding-top: 15px;"><?php the_field('ponedelnik'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('ponedelnik-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('vtornik') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('vtornik'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('vtornik-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('sreda') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('sreda'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('sreda-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('chetverg') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('chetverg'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('chetverg-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('piatnica') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('piatnica'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('piatnica-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('subbota') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('subbota'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('subbota-opisanie'); ?></div>
                                </div>
                                <div class="col-lg-12 tur-ecs2-calendar-hr"></div>
                            <?php } ?>
                            <?php if (get_field('voskresenie') != "") { ?>
                                <div class="row row-color px-2">
                                    <div class="tur-ecs2-title1 center"><?php the_field('voskresenie'); ?></div>
                                    <div class="col-12 col-9r" style="padding-bottom:0px"><?php the_field('voskresenie-opisanie'); ?></div>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div class="carouselOther d-none d-md-block">
                    ...
                    <div id="carouselOtherExcursion" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <?php $x = 0; ?>
                            <?php query_posts('posts_per_page=4&cat=' . $cat_id); ?>
                            <?php $n = ' active';
                            if (have_posts()) : ?>
